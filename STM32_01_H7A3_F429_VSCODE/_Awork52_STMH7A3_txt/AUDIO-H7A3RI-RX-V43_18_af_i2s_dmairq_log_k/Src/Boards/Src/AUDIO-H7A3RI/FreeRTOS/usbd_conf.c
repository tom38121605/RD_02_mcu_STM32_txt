...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = USB_FS_N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(USB_FS_N_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = USB_FS_P_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(USB_FS_P_GPIO_Port, &GPIO_InitStruct);

    /* Peripheral clock enable */
    __HAL_RCC_USB_OTG_HS_CLK_ENABLE();

    /* Peripheral interrupt init */
    HAL_NVIC_SetPriority(OTG_HS_IRQn, PRIO_OTG_FS_IRQn, 0);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE END USB_OTG_HS_MspDeInit 0 */
    ...
    PA12     ------> USB_OTG_HS_DP
    */
    HAL_GPIO_DeInit(USB_FS_N_GPIO_Port, USB_FS_N_Pin);
    HAL_GPIO_DeInit(USB_FS_P_GPIO_Port, USB_FS_P_Pin);
