...
//if( flg_dmairq2==10)      flg_dmairq |=1;   //--test  //yes

//if (DMA_CheckFifoParam(hdma) != HAL_OK);  //--test
  ...
  {
//if( flg_dmairq2==10)      flg_dmairq |=2;   //--test   //no
  ...
  {
//if( flg_dmairq2==10)      flg_dmairq |=4;   //--test  //no
  ...
  {
//if( flg_dmairq2==10)      flg_dmairq |=8;   //--test  //no
...
flg_dmairq |=8;       //no
    ...
    if ((tmpisr_dma & (DMA_FLAG_HTIF0_4 << (hdma->StreamIndex & 0x1FU))) != 0U)
    {
flg_dmairq |=16;       //no  // yes in playing
      if(__HAL_DMA_GET_IT_SOURCE(hdma, DMA_IT_HT) != 0U)
      {
        /* Clear the half transfer complete flag */
        regs_dma->IFCR = DMA_FLAG_HTIF0_4 << (hdma->StreamIndex & 0x1FU);
