...
#define AUDIO_MAX_PACKET_WITH_FEEDBACK_LENGTH(freq,channel_count,res_byte) AUDIO_USB_MAX_PACKET_SIZE(frequency + 1, channels_count, resolution)
#define AUDIO_MAX_PACKET_WITH_FEEDBACK_LENGTH_FROM_AUDIO_DESC(audio_desc) AUDIO_USB_MAX_PACKET_SIZE((audio_desc)->frequency + 1, (audio_desc)->channels_count, (audio_desc)->resolution)
